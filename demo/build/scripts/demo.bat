...
set CLASSPATH=%APP_HOME%\lib\demo.jar;%APP_HOME%\lib\joda-time-2.2.jar

@rem Execute demo
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DEMO_OPTS%  -classpath "%CLASSPATH%" javaProgram.prog %CMD_LINE_ARGS%
